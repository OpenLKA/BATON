...
<p>
  ...
  <a href="https://creativecommons.org/licenses/by/4.0/">
    <img src="https://img.shields.io/badge/License-CC_BY_4.0-lightgrey.svg?style=for-the-badge"/>
  </a>
</p>

*A large-scale multimodal benchmark for bidirectional human–DAS control transition in naturalistic driving*<br/>
*Submitted to ACM Multimedia 2025*
...
<div align="center">
  ...
  <br/>
  <sub><b>Nighttime driving</b> — time-lapse with <b>⬆ DAS Activation</b> and <b>↩ Human Takeover</b> event highlights</sub>
</div>
...
| 🤖 DAS Driving | 🧑 Human Driving | ↩️ Activation | ↪️ Takeover | 🌍 Coverage |
|:--------------:|:----------------:|:-------------:|:-----------:|:-----------:|
...
<tr>
  ...
  <td align="center"><img src="https://huggingface.co/datasets/HenryYHW/BATON/resolve/main/figs/qcamera_activation.jpg" width="100%"/><br/><sub>⬆️ Activation</sub></td>
</tr>
<tr>
...
| ⬆️ **Task 2** | DAS Activation prediction (Human→DAS) | 56,564 | Activation (14.9%) · No Activation | AUPRC |
...
The dataset is released under **CC BY 4.0**. The benchmark code in this repository is released for academic research purposes.
